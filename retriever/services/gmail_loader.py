...
class GmailReader(BaseReader, BaseModel):
    ...
    def search_messages(self):
        ...
        results = self.service.users().messages().list(userId="me", q=query, maxResults=int(max_results)).execute()
    ...
    def get_message_data(self, message):
        ...
        message_data = self.service.users().messages().get(format="raw", userId="me", id=message_id).execute()
